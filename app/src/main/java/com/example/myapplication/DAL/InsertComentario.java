...
public class InsertComentario {
    ...
    public void insertComentario(String url, Context contexto, Comentario comentario, Response.Listener<String> callback, Response.ErrorListener errorListener) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, response -> {
            ...
            public byte[] getBody() throws AuthFailureError {
                try {
                    ...
                    jsonBody.put("texto", comentario.getTexto());
                    jsonBody.put("idPublicacion", comentario.getIdPublicacion());
                    jsonBody.put("idMascota", comentario.getIdMascota());
