...
public class InsertMascota {

    public void registrarMascota(String url, Context contexto, Mascota mascota, Response.Listener<String> callback, Response.ErrorListener errorListener) {
