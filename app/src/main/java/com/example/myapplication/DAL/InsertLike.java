...
public class InsertLike {
    ...
    public void likear(String url, Context contexto, String idPublicacion, Response.Listener<String> callback, Response.ErrorListener errorListener) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, response -> {
            ...
            public byte[] getBody() throws AuthFailureError {
                try {
                    ...
                    jsonBody.put("idPublicacion", idPublicacion);
