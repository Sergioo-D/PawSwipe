...
public class ShowPerfilVisitado {
    public void datosPerfilVisitado(String url, Context contexto, int idMascota, Response.Listener<String> listener, Response.ErrorListener errorListener) {
