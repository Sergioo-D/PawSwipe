...
public class DeletePost {
    public void eliminarPublicacion(String url, Context contexto, Publicacion publicacion, Response.Listener<String> listener, Response.ErrorListener errorListener) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
            ...
            public byte[] getBody() throws AuthFailureError {
                try {
                    ...
                    jsonBody.put("id", publicacion.getId());
